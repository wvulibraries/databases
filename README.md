...
- bin/rails generate scaffold AccessPlainText name:text --no-migration

- bin/rails generate scaffold AccessType name:string --no-migration
...
- bin/rails generate scaffold Vendor name:string url:string --no-migration